content = '''# Veritas Transaction Specification v0.2
...
| 规范定义 | 当前代码 | 未来方向 |
|---|---|---|
| TransactionContext | types.rs TransactionContext | 增加 call_stack |
...
with open('docs/constitution/transaction.md', 'w') as f:
    f.write(content)
print('Done: docs/constitution/transaction.md v0.2 final')
